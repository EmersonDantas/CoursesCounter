...
public class UserDBH extends DataBaseHelper {
    private static UserDBH instance;

    private UserDBH(@Nullable Context context) {
        super(context);
    }
    ...
    public static UserDBH getInstance(Context context){
        if(instance == null){
            instance = new UserDBH(context);
        }
